...
const Sidebar = ({setToken}) => {
  return (
    <div className="max-sm:flexCenter max-sm:pb-3 rounded bg-white pb-3 sm:w-1/5 sm:min-h-screen">
      <div className="flex flex-col gap-y-6 max-sm:items-center sm:flex-col pt-4">
        {/* Logo */}
        <Link to={"/"} className="bold-22 xl:bold-32 sm:pl-2 ">
        ...
        <div className="flex sm:flex-col gap-x-5 gap-y-8 sm:pt-10">
          ...
          >
            <MdFactCheck />
            <div className="hidden lg:flex">Order</div>
          </NavLink>
