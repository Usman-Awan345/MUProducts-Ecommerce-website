            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-7">
              ...
              <div className="flex flex-col gap-1 rounded-lg p-4 bg-white">
                ...
                <p>
                  ...
                  Neque, alias. Fuga impedit tempora culpa beatae, corrupti,
                  facere tempore officiis, quis veniam rerum officia voluptate
                  minus tenetur ex quisquam esse quia.
                </p>
                <div className="flex gap-x-1 mt-5">
                  <img src={product1} alt="productImg" height={44} width={44} className="rounded aspect-square object-cover" />
                  <img src={product2} alt="productImg" height={44} width={44} className="rounded aspect-square object-cover" />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1 rounded-lg p-4 bg-white">
                <div className="flexBetween ">
                  <div className="flexCenter gap-x-3">
                    <img
                      ...
                      className="rounded-full"
                    />
                    <h5 className="bold-14">Angellina</h5>
                  </div>
                  <div className="bg-secondary text-white rounded-full flexCenter gap-x-2 p-1 px-2 text-xs font-semibold">
                    <FaCheck />
                    Verified
                ...
                <h4 className="h4">Modren Design</h4>
                <p>
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Neque, alias. Fuga impedit tempora culpa beatae, corrupti,
                  facere tempore officiis, quis veniam rerum officia voluptate
                ...
                <div className="flex gap-x-1 mt-5">
                  <img src={product3} alt="productImg" height={44} width={44} className="rounded aspect-square object-cover" />
                  <img src={product4} alt="productImg" height={44} width={44} className="rounded aspect-square object-cover" />
                </div>
              </div>
