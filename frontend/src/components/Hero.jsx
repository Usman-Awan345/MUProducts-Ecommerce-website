  ...
  return (
    <section className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[667px] w-full mb-10 relative'>
        ...
        <div className='mt-12 sm:mt-20 xl:mt-40 max-w-[777px]'>
            <h5 className='flex items-baseline gap-x-2 uppercase text-secondary medium-18'>MODREN COLLECTION<BsFire/></h5>
            <h1 className='h1 font-[500] capitalize max-w-[722px]'>Every click brings you closer to prefection shop now!</h1>
            <div className='flex' >
                <Link className='bg-white text-xs font-medium pl-5 rounded-full flexCenter gap-x-2 group'>
                Check our modren Collection 
